...
# ================= 2. 生成并写入 cordova_bridge.js (无侵入原生桥接层) =================
CORDOVA_BRIDGE_CODE = r"""/**
...
bridge_file_path = os.path.join(UPSTREAM_DIR, "cordova_bridge.js")
with open(bridge_file_path, "w", encoding="utf-8") as f:
    f.write(CORDOVA_BRIDGE_CODE)
print(f"[Success] 成功生成并写入原生桥接层: {bridge_file_path}")
